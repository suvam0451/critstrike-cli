...
// Package unrealremark provides interface for source-source code transpilation
package unrealremark

// WARNING : This module is focused towards plugin developers to automate wrapper code generation.
// In production, you should always try to provide BP functionality simultaneously.

/**
This module parses your header(.h) files for comments and injects code/macros/comments as
necessary.. the parser is smart enough to avoid conflicts.
